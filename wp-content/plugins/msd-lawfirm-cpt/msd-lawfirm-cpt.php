<?php
/*
Plugin Name: MSD Lawfirm CPT
Description: Custom plugin for Rendigs.com
...
if (!class_exists('MSDLawfirmCPT')) {
    class MSDLawfirmCPT {
    	 ...
    	 */
    	var $optionsName = 'msd_lawfirm_options';
    	
    	/**
    	 * @var string $nonce String used for nonce security
    	 */
    	var $nonce = 'msd_lawfirm-update-options';
    	
    	/**
    	 * @var string $localizationDomain Domain used for localization
    	 */
    	var $localizationDomain = "msd_lawfirm";
        ...
        */        
        function __construct(){
        	...
        	if(class_exists('MSDLawfirmAttorneyCPT')){
        		$this->cpt_class = new MSDLawfirmAttorneyCPT();
