...
$settings_form->add_setting( array(
	...
	'after'		=>		' <span class="pb_backupbuddy_ftpdestination_pathpicker">
							<a href="#" class="button secondary-button" title="Browse FTP Folders">Browse & Select (beta)</a>
							<img class="pb_backupbuddy_ftppicker_load" style="vertical-align: -3px; margin-left: 5px; display: none;" src="http://backupbuddy/wp-content/plugins/backupbuddy/images/loading.gif" title="Loading... This may take a few seconds...">
						</span>
