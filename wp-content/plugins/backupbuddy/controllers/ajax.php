...
class pb_backupbuddy_ajax extends pb_backupbuddy_ajaxcore {
	...
	public function db_check() {
		...
		$result = mysql_query( "CHECK TABLE `" . mysql_real_escape_string( $table ) . "` " . $check_level, $wpdb->dbh );
	...
	public function db_repair() {
		...
		$result = mysql_query( "REPAIR TABLE `" . mysql_real_escape_string( $table ) . "`", $wpdb->dbh );
		echo '<b>Results:</b><br><br>';
		echo '<table class="widefat">';
		while( $rs = mysql_fetch_array( $result ) ) {
			echo '<tr>';
